...
+ (void)queryHistorySellInfoWithPhone:(NSString *)customID
                         ...
                         FailureBlock:(void (^)(NSError * error))failure
{
    [self postRequest:@{@"pageNo":@(page),@"maxPageSize":@(20),@"customerId":customID} RequestMethod:CustomerRequest_CustomerOrderList CacheEnable:IPCRequestCacheEnable SuccessBlock:success FailureBlock:failure];
}
...
{
    [self postRequest:@{@"keyword" : code} RequestMethod:CustomerRequest_ValidateCustomer CacheEnable:IPCRequestCacheDisEnable SuccessBlock:success FailureBlock:failure];
}
...
+ (void)getProductConfigWithSuccessBlock:(void (^)(id))success FailureBlock:(void (^)(NSError *))failure
{
    [self postRequest:nil RequestMethod:CustomerRequest_ProductConfig CacheEnable:IPCRequestCacheDisEnable SuccessBlock:success FailureBlock:failure];
}
