...
- (void)setCustomerOrder:(IPCCustomerOrderMode *)customerOrder{
    ...
    if (_customerOrder) {
        ...
        [self.orderPriceLabel setAttributedText:[IPCCustomUI subStringWithText:pirce BeginRang:6 Rang:pirce.length - 6 Font:[UIFont systemFontOfSize:16] Color:COLOR_RGB_RED]];
