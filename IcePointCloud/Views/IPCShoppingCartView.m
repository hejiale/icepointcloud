...
@interface IPCShoppingCartView ()<UITableViewDelegate,UITableViewDataSource>
...
- (void)awakeFromNib{
    ...
    [self.navigationTitleLabel setText:[NSString stringWithFormat:@"购物车 (%d)",(long)[[IPCShoppingCart sharedCart] allGlassesCount]]];
...
- (IBAction)onCheckoutAction:(id)sender {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    return  [self.cartItemViewCellMode tableView:tableView cellForRowAtIndexPath:indexPath];
}
